...
import bunny.lib.utils.AdvancementUtil;
...
public class ModAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(RegistryWrapper.WrapperLookup registryLookup, Consumer<AdvancementEntry> consumer) {
        AdvancementEntry entryToMastery = Advancement.Builder.create()
                ...
                .build(consumer, BunnyLib.MOD_ID + "/got_lots_nether_stars");
        ...
        AdvancementEntry nametagCollector = Advancement.Builder.create()
                ...
                .build(consumer, BunnyLib.MOD_ID + "/obtain_rare_name_tag");
        ...
        AdvancementEntry nametagMastery = Advancement.Builder.create()
                ...
                .build(consumer, BunnyLib.MOD_ID + "/obtain_all_rare_name_tag");
    }
}
