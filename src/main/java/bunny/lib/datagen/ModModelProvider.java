...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        for (DyeColor color : DyeColor.values()) {
            ...
            pool.stairs(Registries.BLOCK.get(Identifier.of(BunnyLib.MOD_ID, color + "_concrete_stairs")));
            pool.slab(Registries.BLOCK.get(Identifier.of(BunnyLib.MOD_ID, color + "_concrete_slab")));
            pool.wall(Registries.BLOCK.get(Identifier.of(BunnyLib.MOD_ID, color + "_concrete_wall")));
        }
