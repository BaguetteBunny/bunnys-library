...
import bunny.lib.utils.WoodTypeData;
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            private static RegistryKey<Recipe<?>> idOfPaintingEntry(RegistryEntry<PaintingVariant> entry) {
                ...
                Identifier recipeId = Identifier.of(BunnyLib.MOD_ID, "painting_to_" + variantId.getPath() + "_sawmilling");
            ...
            public void generate() {
                ...
                createShapeless(RecipeCategory.MISC, Items.LIGHT_BLUE_DYE, 2)
                        ...
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(BunnyLib.MOD_ID, "light_blue_dye_from_mystic_rose")));
                ...
                createShapeless(RecipeCategory.MISC, Items.LIGHT_BLUE_DYE, 2)
                        ...
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(BunnyLib.MOD_ID, "light_blue_dye_from_shiny_cornflower")));
                ...
                for (DyeColor color : DyeColor.values()) {
                    ...
                    offerStairRecipe(exporter, Registries.BLOCK.get(Identifier.of("bunny-lib", color.getName() + "_concrete_stairs")), base);
                    offerSlabRecipe(RecipeCategory.BUILDING_BLOCKS, Registries.BLOCK.get(Identifier.of("bunny-lib", color.getName() + "_concrete_slab")), base);
                    offerWallRecipe(RecipeCategory.BUILDING_BLOCKS, Registries.BLOCK.get(Identifier.of("bunny-lib", color.getName() + "_concrete_wall")), base);
                    offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, Registries.BLOCK.get(Identifier.of("bunny-lib", color.getName() + "_concrete_stairs")), base, 1);
                    offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, Registries.BLOCK.get(Identifier.of("bunny-lib", color.getName() + "_concrete_slab")), base, 2);
                    offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, Registries.BLOCK.get(Identifier.of("bunny-lib", color.getName() + "_concrete_wall")), base, 1);
                }
            }
        };
    }
