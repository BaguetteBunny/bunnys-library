    ...
    private static final Map<BearVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(BearVariant.class), map -> {
                map.put(BearVariant.DEFAULT,
                        Identifier.of(BunnyLib.MOD_ID, "textures/entity/bear/brown_bear.png"));
                map.put(BearVariant.SILLY,
                        Identifier.of(BunnyLib.MOD_ID, "textures/entity/bear/silly_brown_bear.png"));
                map.put(BearVariant.SILLIEST,
                        Identifier.of(BunnyLib.MOD_ID, "textures/entity/bear/silliest_brown_bear.png"));
            });
