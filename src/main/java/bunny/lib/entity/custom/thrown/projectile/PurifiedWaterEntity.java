...
import bunny.lib.utils.ParticleShapeUtil;
...
import static bunny.lib.utils.RadiusGetterUtil.*;
...
public class PurifiedWaterEntity extends ThrownItemEntity {
    ...
    static {
        ...
        PURIFIED_WATER_BLOCK_TRANSFORM.put(ModBlocks.INFUSED_BONE_BLOCK, Blocks.BONE_BLOCK);
    }
