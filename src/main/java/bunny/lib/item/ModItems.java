package bunny.lib.item;

import bunny.lib.item.custom.*;
...
public class ModItems {
    ...
    public static Item registerItem(String name, Function<Item.Settings, Item> function) {
        return Registry.register(Registries.ITEM, Identifier.of(BunnyLib.MOD_ID, name),
                function.apply(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(BunnyLib.MOD_ID, name)))));
    }

    public static void registerModItems() {
        BunnyLib.LOGGER.info("Registering Mod Items for " + BunnyLib.MOD_ID);
