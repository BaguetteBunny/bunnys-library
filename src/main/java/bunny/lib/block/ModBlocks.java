package bunny.lib.block;


import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import bunny.lib.BunnyLib;
import bunny.lib.block.custom.AdvancedFletchingTable;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Function<AbstractBlock.Settings, Block> function) {
        Block toRegister = function.apply(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(BunnyLib.MOD_ID, name))));
        registerBlockItem(name, toRegister);
        return Registry.register(Registries.BLOCK, Identifier.of(BunnyLib.MOD_ID, name), toRegister);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(BunnyLib.MOD_ID, name),
                new BlockItem(block, new Item.Settings().useBlockPrefixedTranslationKey()
                        .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(BunnyLib.MOD_ID, name)))));
    }

    public static void registerModBlocks() {
        BunnyLib.LOGGER.info("Registering Mod Blocks for " + BunnyLib.MOD_ID);
