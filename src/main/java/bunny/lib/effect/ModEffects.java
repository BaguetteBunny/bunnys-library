package bunny.lib.effect;

import bunny.lib.BunnyLib;
import bunny.lib.effect.custom.DwarfismEffect;
import bunny.lib.effect.custom.GigantismEffect;
import bunny.lib.effect.custom.GroundedEffect;
...
public class ModEffects {
    public static final RegistryEntry<StatusEffect> GROUNDED = registerStatusEffect("grounded",
            new GroundedEffect(StatusEffectCategory.HARMFUL, 0xa67655)
                    .addAttributeModifier(EntityAttributes.MOVEMENT_SPEED,
                            Identifier.of(BunnyLib.MOD_ID, "grounded"), -0.25f,
    ...
    private static RegistryEntry<StatusEffect> registerStatusEffect(String name, StatusEffect statusEffect) {
        return Registry.registerReference(Registries.STATUS_EFFECT, Identifier.of(BunnyLib.MOD_ID, name), statusEffect);
    }

    public static void registerEffects() {
        BunnyLib.LOGGER.info("Registering Mod Effects for " + BunnyLib.MOD_ID);
    }
}
