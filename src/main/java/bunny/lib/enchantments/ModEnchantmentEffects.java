...
public class ModEnchantmentEffects {
    ...
    public static final MapCodec<? extends EnchantmentEntityEffect> SEA_CONQUEROR =
            registerEntityEffect("sea_conqueror", SeaConquerorEnchantmentEffect.CODEC);

    private static MapCodec<? extends EnchantmentEntityEffect> registerEntityEffect(String name, MapCodec<? extends EnchantmentEntityEffect> codec) {
        return Registry.register(Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE, Identifier.of(BunnyLib.MOD_ID, name), codec);
    }

    public static void registerEnchantmentEffects() {
        BunnyLib.LOGGER.info("Registering Mod Enchantment Effects for " + BunnyLib.MOD_ID);
    }
}
