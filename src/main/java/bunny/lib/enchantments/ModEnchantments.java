package bunny.lib.enchantments;

import bunny.lib.BunnyLib;
import bunny.lib.enchantments.custom.LifestealEnchantmentEffect;
import bunny.lib.enchantments.custom.ShieldAuraEnchantmentEffect;
import bunny.lib.enchantments.custom.*;
...
public class ModEnchantments {
    public static final RegistryKey<Enchantment> VAMPIRISM =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "vampirism"));
    public static final RegistryKey<Enchantment> SMELTING =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "smelting"));
    public static final RegistryKey<Enchantment> TILLING =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "tilling"));
    public static final RegistryKey<Enchantment> MAGIC_TOUCH =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "magic_touch"));
    public static final RegistryKey<Enchantment> FIRE_BLAST =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "fire_blast"));
    public static final RegistryKey<Enchantment> GIANT_KILLER =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "giant_killer"));
    public static final RegistryKey<Enchantment> ILLAGERS_BANE =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "illagers_bane"));
    public static final RegistryKey<Enchantment> REELING =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "reeling"));
    public static final RegistryKey<Enchantment> DOUBLE_HOOK =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "double_hook"));
    public static final RegistryKey<Enchantment> SHIELD_BASH =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "shield_bash"));
    public static final RegistryKey<Enchantment> RECOVERY =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "recovery"));
    public static final RegistryKey<Enchantment> SHIELD_AURA =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "shield_aura"));
    public static final RegistryKey<Enchantment> TAILORING =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "tailoring"));
    public static final RegistryKey<Enchantment> EXCAVATOR =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "excavator"));
    public static final RegistryKey<Enchantment> SEA_CONQUEROR =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(BunnyLib.MOD_ID, "sea_conqueror"));
    ...
    public static void bootstrap(Registerable<Enchantment> registerable) {
        ...
        register(registerable, EXCAVATOR, Enchantment.builder(Enchantment.definition(
                ...
                .addEffect(EnchantmentEffectComponentTypes.ATTRIBUTES, new AttributeEnchantmentEffect(
                        Identifier.of(BunnyLib.MOD_ID, "excavator_range"),
        ...
        register(registerable, SEA_CONQUEROR, Enchantment.builder(Enchantment.definition(
                ...
                .addEffect(EnchantmentEffectComponentTypes.ATTRIBUTES, new AttributeEnchantmentEffect(
                        Identifier.of(BunnyLib.MOD_ID, "sea_conqueror_range"),
